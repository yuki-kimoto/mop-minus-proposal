# This Makefile is for the mop::minus extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/mop/minus.pm]
...
MAKEMAKER   = /home/kimoto/perl5/perlbrew/perls/perl-5.20.1/lib/5.20.1/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.98
MM_REVISION = 69800
...
INST_LIBDIR      = $(INST_LIB)/mop
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/mop
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''mop minus proposal'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: mop-minus' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "mop minus proposal",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "mop-minus",' >> META_new.json
